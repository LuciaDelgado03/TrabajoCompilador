...
%token IF THEN ELSE BEGIN END END_IF OUTF TYPEDEF FUN RET STRING REPEAT WHILE GOTO ID DIGITO HEXA CML DOUBLE LONGINT TOD STRUCT
ASIGNACION DISTINTO MENOR_IGUAL MAYOR_IGUAL OUTF ETIQUETA
...
sentencia_funcion			: tipo FUN ID "(" parametro ")" BEGIN cuerpo_funcion END
							| tipo FUN ID "(" parametro ")" BEGIN cuerpo_funcion sentencia_retorno END
							;
